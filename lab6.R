...
## read data
NY_House_Dataset <- read.csv("C:/D_Drive/Arya/NTU/exchange/study/DA stuff/NY-House-Dataset.csv")
...
tuned.svm <- tune.svm(log10(PRICE) ~ log10(PROPERTYSQFT), data=dataset.sub0, kernel="radial", gamma = 10^seq(-3,2,1), cost = 10^seq(-3,2,1), tune.control=tune.control(cross = 2))
tuned.svm
